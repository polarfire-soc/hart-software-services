...
static int mpfs_console_init(void)
{
	...
	//return uart8250_init(MPFS_UART0_ADDR, peri_in_freq, MPFS_UART_BAUDRATE, 0, 4);
	return 0;
}
...
const struct sbi_platform platform = {
	...
	.console_putc = 0lu, //uart8250_putc,
	.console_getc = 0lu, //uart8250_getc,
