...
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_WL    0x00000010UL
    /* CFG_WL                            [0:32]  RW value= 0x10 */ 
#endif
#if !defined (LIBERO_SETTING_CFG_RL)
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_RL    0x00000020UL
    /* CFG_RL                            [0:32]  RW value= 0x20 */ 
#endif
