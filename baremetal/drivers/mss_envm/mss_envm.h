 ...
 * 
 * PolarFire SoC MSS Peripheral DMA bare metal software driver public APIs.
 *
 * SVN $Revision: 10489 $
...
#define FM_SYS_START_ADDR 	0x20200000  			//Base address for C_BUS set by Microsemi. All other REG_IF registers are offset from this address - C_Bus address base
...
extern PageLatchData pageLatchData;
extern WriteRowData writeRowData;
extern ReadRowData readRowData;
extern EnvmTrims envmTrims;
extern EnvmReadTrims envmReadTrims;


//Need SRAM start address and FLash start address
...
//Larger Subroutines
uint32_t ReadFlash(uint32_t lChksmStAddr, uint32_t lChksmEndAddr);
void MargReadReset(void);
