 ...
 *
 * SVN $Revision: 12153 $
 * SVN $Date: 2019-08-22 12:05:43 +0530 (Thu, 22 Aug 2019) $
 */
...
)
{
    ...
    HAL_ASSERT((this_spi == &g_mss_spi0_lo) || (this_spi == &g_mss_spi1_lo));
...
)
{
    ...
    HAL_ASSERT(0u == (clk_div & 0x00000001U));
...
)
{
    ...
    HAL_ASSERT((this_spi->hw_reg->CONTROL & CTRL_MASTER_MASK)
               == CTRL_MASTER_MASK);
