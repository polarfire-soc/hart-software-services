...
#define MSS_SYSTEM_CLK                  70000000UL   /* PLIC,CLINT,DEBUG,PORTS  */
#define MSS_RTC_TOGGLE_CLK               1000000UL   /* RTC clk input, must run at less than 1/2 rate of MSS_SYSTEM_CLK  */
#define MSS_AXI_SWITCH_CLK              70000000UL
#define MSS_AHB_APB_CLK                 70000000UL
#if 1
#else
