...
mpfs_mss_rtc_interrupt_renode_hart0 _start_platform_and_debug.launch which is 
...
Build the project and launch the debug configuration named 
mpfs_mss_rtc_interrupt_hw_emulation_all_harts_debug.launch which is configured 
