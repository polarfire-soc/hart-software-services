...
mpfs-gpio-example-Start-Renode-and-attache-hart0.launch which is configured to
start Renode and launch debug session connecting to hart0. 
...
Build the project and launch the debug configuration named 
mpfs-gpio-example-all-harts Debug.launch which is configured for PolarFire SoC 
hardware platform.