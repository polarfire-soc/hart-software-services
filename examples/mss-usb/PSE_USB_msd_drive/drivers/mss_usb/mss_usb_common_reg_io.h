 ...
 *
 * SVN $Revision: 10864 $
 * SVN $Date: 2019-01-23 13:48:51 +0530 (Wed, 23 Jan 2019) $
 */
...
{
    USB->ENDPOINT[ep_num].RX_CSR |= (RxCSRL_REG_EPN_SEND_STALL_MASK | RxCSRL_REG_EPN_RX_PKT_RDY_MASK);
}
...
)
{
    ...
    USB->ENDPOINT[ep_num].RX_CSR |= (RxCSRL_REG_EPN_CLR_DAT_TOG_MASK | RxCSRL_REG_EPN_RX_PKT_RDY_MASK);
}
...
{
    USB->ENDPOINT[ep_num].RX_CSR |= (RxCSRL_REG_EPN_DMA_MODE_MASK | RxCSRL_REG_EPN_RX_PKT_RDY_MASK);
}
...
{
    USB->ENDPOINT[ep_num].RX_CSR |= (RxCSRL_REG_EPN_ENABLE_DMA_MASK | RxCSRL_REG_EPN_RX_PKT_RDY_MASK);
}
...
)
{
    ...
    USB->ENDPOINT[ep_num].RX_CSR |= (RxCSRL_REG_EPN_BI_DIS_NYET_MASK | RxCSRL_REG_EPN_RX_PKT_RDY_MASK);
}
...
{
    USB->ENDPOINT[ep_num].RX_CSR |= (RxCSRL_REG_EPN_ENABLE_ISO_MASK | RxCSRL_REG_EPN_RX_PKT_RDY_MASK);
}
...
{
    USB->ENDPOINT[ep_num].RX_CSR |= (RxCSRL_REG_EPN_ENABLE_AUTOCLR_MASK | RxCSRL_REG_EPN_RX_PKT_RDY_MASK);
}
