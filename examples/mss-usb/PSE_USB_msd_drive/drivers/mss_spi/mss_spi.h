 ...
 * 
 * PolarFire SoC (PSE) microcontroller subsystem SPI bare metal software
 * driver public API.
 *
...
/*=========================================================================*//**
  ...
  The PolarFire SoC microcontroller subsystem (MSS) includes two serial
  ...
  IOMUXs, refer to the IOMUX section of the PolarFire SoC Microcontroller
  Subsystem (MSS) User�s Guide.
  The base address, register addresses and interrupt number assignment for the
  MSS SPI peripherals are defined as constants in the PolarFire SoC CMSIS HAL.
...
#define SPI0_BASE               0x20108000u
#define SPI1_BASE               0x20109000u
...
typedef struct __mss_spi_instance_t
{
    ...
    PLIC_IRQn_Type          irqn;       /*!< SPI's Cortex-M3 NVIC interrupt number. */
