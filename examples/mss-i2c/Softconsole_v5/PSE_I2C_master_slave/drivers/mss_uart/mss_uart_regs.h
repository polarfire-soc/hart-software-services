 ...
 * 
 * Register bit offsets and masks definitions for PolarFire SoC(MPFS) MSS MMUART.
 * 
 * This driver is based on SmartFusion2 MMUART driver v2.1.100
 *
 *
 * SVN $Revision: 11254 $
 * SVN $Date: 2019-05-10 13:43:26 +0530 (Fri, 10 May 2019) $
 */
...
#define CLEAR_TX_FIFO_MASK          (0x01 << 2u)      /* Clear transmitter FIFO */
...
#define TEMT_MASK                   (0x01 << 6u)        /* Transmitter empty */
