 ...
 * All rights reserved.
 *
 * PolarFore SoC Microcontroller Subsystem MMUART bare metal software driver 
 * public API.
 *
...
/*=========================================================================*//**
  ...
  ==============================================================================
  The PolarFire SoC microcontroller subsystem (MSS) includes two multi-mode UART
  ...
  MSS MMUART peripherals are defined as constants in the PolarFire SoC CMSIS HAL.
  You must ensure that the latest PolarFire SoC CMSIS HAL is included in the
  ...
  driver.
  Note: The PolarFire SoC CMSIS-PAL defines the UART0_IRQHandler() and
...
/***************************************************************************//**
  ...
  treated as local interrupt on E51. The value of 1 means that the MMUART 
  interrupt is routed through PLIC
 */
#define MSS_UART_INTR_LOCAL               1
#define MSS_UART_INTR_PLIC                2
...
struct mss_uart_instance{
    ...
    uint8_t                 intr_type;   /*!< 1 => local, 2 => PLIC  3 => Local and PLIC*/
