/***********************************************************************************
 * (c) Copyright 2019 Microchip Corporation..
 *
 * PolarFire SoC MSS I2C driver example project demonstrating Loop back
 * operation.
 *
 * SVN $Revision$
 * SVN $Date$
 ...
 */
void i2c0_completion_handler(mss_i2c_instance_t * instance, uint8_t status);
void i2c1_completion_handler(mss_i2c_instance_t * instance, uint8_t status);
...
volatile uint8_t master_status[100] = {0};
volatile uint8_t instance_status[100] = {0};
volatile uint8_t master_index = 0;
volatile uint8_t slave_status[100] = {0};
volatile uint8_t slave_index = 0;
