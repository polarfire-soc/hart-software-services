...
configure the MSS RTC block as real time clock in calender mode. The 
...
mpfs_mss_rtc_time_renode_hart0 _start_platform_and_debug.launch which is 
...
Build the project and launch the debug configuration named 
mpfs_mss_rtc_time_hw_emulation_all_harts_debug.launch which is configured 
